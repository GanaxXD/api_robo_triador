...
public class ExecucaoMandados {
	...
	public boolean validarDadosDa(ExecucaoMandados ex) {
		if (ex == null || ex.getHoraInicialExecucaoRobo() == null || ex.getHoraInicialExecucaoRobo().isBlank()
				|| ex.getHoraInicialExecucaoRobo().isEmpty() || ex.getTempoDistribuindoMandados() == null) {
			return false;
		}
		return true;
	}
